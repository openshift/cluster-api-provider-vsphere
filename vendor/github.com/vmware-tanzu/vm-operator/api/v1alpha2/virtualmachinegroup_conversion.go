...
func (src *VirtualMachineGroup) ConvertTo(dstRaw ctrlconversion.Hub) error {
	...
	return Convert_v1alpha2_VirtualMachineGroup_To_v1alpha6_VirtualMachineGroup(src, dst, nil)
}
...
func (dst *VirtualMachineGroup) ConvertFrom(srcRaw ctrlconversion.Hub) error {
	...
	return Convert_v1alpha6_VirtualMachineGroup_To_v1alpha2_VirtualMachineGroup(src, dst, nil)
}
...
func (src *VirtualMachineGroupList) ConvertTo(dstRaw ctrlconversion.Hub) error {
	...
	return Convert_v1alpha2_VirtualMachineGroupList_To_v1alpha6_VirtualMachineGroupList(src, dst, nil)
}
...
func (dst *VirtualMachineGroupList) ConvertFrom(srcRaw ctrlconversion.Hub) error {
	...
	return Convert_v1alpha6_VirtualMachineGroupList_To_v1alpha2_VirtualMachineGroupList(src, dst, nil)
}
