...
type VirtualMachineNetworkInterfaceSpec struct {
	...
	Network *vmopv1a5common.PartialObjectRef `json:"network,omitempty"`
...
type VirtualMachineNetworkDHCPOptionsStatus struct {
	...
	Config []vmopv1a5common.KeyValuePair `json:"config,omitempty"`
...
type VirtualMachineNetworkIPStackStatus struct {
	...
	KernelConfig []vmopv1a5common.KeyValuePair `json:"kernelConfig,omitempty"`
}
